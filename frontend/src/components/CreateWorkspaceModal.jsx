...
import { X, Folder, Hash, Type, FileText, Palette, Check, Home, Database, BarChart3, LayoutGrid, Settings, Users, ShoppingCart, Truck, Factory, Wifi, HeartPulse, Package, DollarSign } from "lucide-react";
...
const CreateWorkspaceModal = ({ onClose, onSave }) => {
  ...
  const icons = [
    { name: "Folder", value: "Folder", component: Folder },
    { name: "Database", value: "Database", component: Database },
    { name: "BarChart3", value: "BarChart3", component: BarChart3 },
    { name: "LayoutGrid", value: "LayoutGrid", component: LayoutGrid },
    { name: "Settings", value: "Settings", component: Settings },
    { name: "FileText", value: "FileText", component: FileText },
    { name: "Users", value: "Users", component: Users },
    { name: "Home", value: "Home", component: Home },
    { name: "ShoppingCart", value: "ShoppingCart", component: ShoppingCart },
    { name: "Truck", value: "Truck", component: Truck },
    { name: "Factory", value: "Factory", component: Factory },
    { name: "Wifi", value: "Wifi", component: Wifi },
    { name: "HeartPulse", value: "HeartPulse", component: HeartPulse },
    { name: "Package", value: "Package", component: Package },
    { name: "DollarSign", value: "DollarSign", component: DollarSign },
  ];
            ...
            <div className="icon-options">
              {icons.map((iconOption) => {
                ...
                return (
                  ...
                  >
                    <div className="icon-preview" style={{ backgroundColor: `${color}20` }}>
